<?php
 ...
 if(isset($_POST['tun']) && $_POST['tun'] != "")
 {
  ...
  {
   echo "<script>alert('Password Updated'); document.location.href='teacher_home.php';</script>";
  }
  else
  {
   echo "<script>alert('Error. Please Retry'); document.location.href = 'teacher_change_password.php';</script>";
  }
 }
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
   ...
   function doLogin() 
   {
	if (document.getElementById('tpw').value == "") 
	{
	 ...
	 document.getElementById("form37").tpw.focus();
	}
	...
	else if (document.getElementById('cpw').value == "") 
	{
	 ...
	 document.getElementById("form37").cpw.focus();
	}
	...
	{
	 document.getElementById('form37').action = 'teacher_change_password.php';
	 document.getElementById('form37').submit();
	}
   }
  </script>
 </head>
 ...
 <body>
  <form method='post' id="form37" action="" name="form37">
   <div id="wrapper">
	<div id="header">
	...
	<div id="page">
	 <div id="page-bgtop">
	  <div id="page-bgbtm">
	   <div id="content">
		<div class="post"> <h2 class="title"><a href="#">Change Teacher Password</a></h2>
	   ...
	   <div id="sidebar">
		<ul><li> <h2> Teacher Home</h2> <div ></div><br /> </li>
			<li><ul><li><a href="teacher_home.php">Home</a></li>
					...
					<li><a href="teacher_change_password.php" style="text-decoration:none;">Change Password</a></li>

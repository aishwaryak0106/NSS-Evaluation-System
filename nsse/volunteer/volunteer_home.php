...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
  <form method='post' id="form45" action="" name="form45">
   <div id="wrapper">
	<div id="header">
	  ...
	  <div id="page-bgbtm">
	     ...
	     <div class="entry" style="line-height:25px;">
          <div class = "main"> 
           <marquee class="marq" bgcolor = "white" direction = "down" loop="" > 
            <img src="../img/volunteer_mq1.jpg" width="500" height="250" align="center" /><br /><br />
			<img src="../img/volunteer_mq2.jpg" width="500" height="250" align="center" /><br /><br />
			<div class="geek1">VOLUNTEER PAGE</div><br />
            <div class="geek2"></div> 
		   </marquee> 
          </div><br /> <br />
         </div>
	   ...
	   <div id="sidebar">
		<ul><li> <h2> Volunteer Home</h2> <div ></div><br /> </li>
			<li><ul><li><a href="volunteer_home.php" style="text-decoration:none;">Home</a></li>

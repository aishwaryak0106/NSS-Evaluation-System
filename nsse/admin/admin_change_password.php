<?php
 ...
 if(isset($_POST['tun']) && $_POST['tun'] != "")
 {
  ...
  {
   echo "<script>alert('Password Updated'); document.location.href='admin_home.php';</script>";
  }
  else
  {
   echo "<script>alert('Error. Please Retry'); document.location.href = 'admin_change_password.php';</script>";
  }
 }
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
   ...
   function doLogin() 
   {
	if (document.getElementById('tpw').value == "") 
	{
	 ...
	 document.getElementById("form7").tpw.focus();
    }
	...
	else if (document.getElementById('cpw').value == "") 
	{
	 ...
	 document.getElementById("form7").cpw.focus();
	}
	...
	{
	 document.getElementById('form7').action = 'admin_change_password.php';
 ...
 <body>
  <form method='post' id="form7" action="" name="form7">
   <div id="wrapper">
	<div id="header">
	...
	<div id="page">
	 <div id="page-bgtop">
	  <div id="page-bgbtm">
	   <div id="content">
		<div class="post"> <h2 class="title"><a href="#"> Change Admin Password</a></h2> 
	   ...
	   <div id="sidebar">
		<ul><li> <h2> Admin Home</h2> <div ></div><br /> </li>
			<li><ul><li><a href="admin_home.php">Home</a></li>
					...
					<li><a href="admin_change_password.php" style="text-decoration:none;">Change Password</a></li>

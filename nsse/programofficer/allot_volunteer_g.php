<?php
 ...
 if(isset($_POST['g']) && $_POST['g'] != "")
 {
  ...
  else
  {
   ...
   if($rows == 1)
   {
	echo "<script>alert('One Girl Added to Group'); document.location.href = 'program_officer_home.php';</script>";
   }
   else
   {
  ...
  <script type="text/javascript">
   ...
   function doSubmit() 
   {
	...
	else if (document.getElementById('sv').value == "Select One Volunteer") 
	{
	 ...
	 document.getElementById("form22").sv.focus();
	}
	else 
	{
	 document.getElementById('form22').action = 'allot_volunteer_g.php';
  ...
  <div id="wrapper">
   ...
   <div id="page">
	<div id="page-bgtop">
	 <div id="page-bgbtm">
	  <div id="content">
		<div class="post"> <h2 class="title"><a href="#"> Allot Volunteer(GIRLS)</a></h2>
	...
	<?php
     ...
     $query ="select volunteerid,concat(fullname, ' [',volunteerid , ']') from volunteerdetails where gender='Female' ;"; 
	   ...
	   <div id="sidebar">
		<ul><li> <h2> Program Officer Home</h2> <div ></div><br /> </li>
			<li><ul><li><a href="program_officer_home.php">Home</a></li>
					...
					<li><a href="allot_volunteer_g.php" style="text-decoration:none;">Allot Volunteer(GIRLS)</a></li>								

...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
  <form method='post' id="form25" action="" name="form25">
    <div id="wrapper">
     <div id="header">
	 ...
	 <div id="page">
	  <div id="page-bgtop">
	   <div id="page-bgbtm">
		<div id="content">
		 <div class="post"><h2 class="title"><a href="#"> Manage Camp</a></h2>
	      <div class="entry" style="line-height:25px;">
	<?php
	 include '../connection.php';
	 $sql = "select campid, title, location, fromcampdate, tocampdate, cost from camp order by title desc ;";
	 $result = mysqli_query($link, $sql);

	 echo "<table style='width:100%;'>";
	 echo "<tr>";
	 echo "<td style='background-color:#1d0058;color:white; padding-left:5px;'>Title</td>";
	 echo "<td style='background-color:#1d0058;color:white; padding-left:5px;'>Location</td>";
	 echo "<td style='background-color:#1d0058;color:white; padding-left:5px;'>From Date</td>";
	 echo "<td style='background-color:#1d0058;color:white; padding-left:5px;'>To Date</td>";
	 echo "<td style='background-color:#1d0058;color:white; padding-left:5px;'>Cost</td>";
	 ...
	 else
	 {
	  while($row = mysqli_fetch_array($result))
	  {
	   ...
	   echo "<td style='color:#1d0058; padding-left:5px;border-bottom:solid 1px #1d0058;'>$row[5]</td>";
	   echo "<td style='color:#1d0058; padding-left:5px;border-bottom:solid 1px #1d0058;'><a href='edit_camp.php?id=$row[0]'>Edit</a></td>";
	   echo "</tr>";
	  }
	 }
	 echo "</table>";
    ...
    <?php  
	 ...
	 $sql = "SELECT SUM(cost) As value_sum FROM camp where status=01";
	 $result = mysqli_query($link, $sql);
